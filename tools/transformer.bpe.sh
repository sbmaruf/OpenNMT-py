...
LANG1="en"
LANG2="ms"
NAME="transformer.bpe.$LANG1-$LANG2"
OUT="$ONMT/onmt-runs/$NAME"
DATA="../../dataset-gen/all_dataset/alt_amara_GNOME_KDE4_OpenSubtitles2016_OpenSubtitles2018_Ubuntu"
train_src="train.en-ms.tok.clean.bpe.50000.$LANG1"
train_tgt="train.en-ms.tok.clean.bpe.50000.$LANG2"
dev_src="dev.en-ms.tok.bpe.50000.$LANG1"
dev_tgt="dev.en-ms.tok.bpe.50000.$LANG2"
test_src="test.en-ms.tok.bpe.50000.$LANG1"
test_tgt="test.en-ms.tok.bpe.50000.$LANG2"
...
VOCAB="$DATA/vocab.bpe.50000" # make it empty if you want to create vocab by Open-NMT-py
VOCAB_TAG="-src_vocab $VOCAB -tgt_vocab $VOCAB -src_vocab_size 60000 -tgt_vocab_size 60000 "
GPUARG="" # default
GPUARG="0"
